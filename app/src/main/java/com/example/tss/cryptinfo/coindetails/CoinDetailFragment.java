package com.example.tss.cryptinfo.coindetails;
...
import com.example.tss.cryptinfo.model.History;
...
public class CoinDetailFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void formatChart(LineChart chart, LineDataSet dataSet) {
        ...
        //dangerous
        xAxis.setValueFormatter((IAxisValueFormatter) new DateFormatter(getContext()));
