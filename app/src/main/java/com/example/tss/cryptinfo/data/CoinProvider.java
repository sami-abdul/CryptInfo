...
import static com.example.tss.cryptinfo.data.CoinDbContract.CONTENT_AUTHORITY;
import static com.example.tss.cryptinfo.data.CoinDbContract.PATH_COINS;
import static com.example.tss.cryptinfo.data.CoinDbContract.PATH_COIN_SYMBOL;
...
public class CoinProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(CONTENT_AUTHORITY, PATH_COINS, COINS);
        matcher.addURI(CONTENT_AUTHORITY, PATH_COIN_SYMBOL, COIN_SYMBOL);
        return matcher;
    }
