...
import com.example.tss.cryptinfo.adapters.CoinAdapter;
...
import com.example.tss.cryptinfo.services.CoinSyncIntentService;
        ...
        if (symbol != null && !symbol.isEmpty()) {
            ...
            if (NetworkUtils.isNetworkStatusAvailable(mContext)) {
                ...
                if (c.getCount() != 0) {
                    ...
                    if (!CoinJsonUtils.INSTANCE.isSymbolValid(mContext, cleanInput)) {
                        Toast toast =
                                Toast.makeText(CoinsActivity.this,
